...
\isamarkupcmt{for any property, exactly one of it%
}
\ \ \isanewline
...
\isamarkupcmt{or its negation must be positive%
}
\ \ \isanewline
...
\isamarkupcmt{perfections closed under entailment%
}
\isanewline
...
\isamarkupcmt{and also under conjunction%
}
\isanewline
\isanewline
\isacommand{lemma}\isamarkupfalse%
