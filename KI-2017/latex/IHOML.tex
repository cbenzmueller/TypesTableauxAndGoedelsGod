...
%
\begin{isamarkuptext}%
\noindent{This work is divided in two parts. The first one introduces a shallow semantic embedding of
...
%
\begin{isamarkuptext}%
\noindent{For the second part, we present an exemplary, non-trivial application of this reasoning infrastructure:
...
%
\begin{isamarkuptext}%
\noindent{We embed each modal operator as the set of worlds satisfying the corresponding HOL formula.}%
\end{isamarkuptext}\isamarkuptrue%
...
\begin{isamarkuptext}%
\noindent{\emph{Possibilist} and \emph{actualist} quantifiers are embedded as follows.
...
\begin{isamarkuptext}%
\noindent{The \emph{existsAt} predicate is used to embed \emph{actualist} quantifiers by restricting the domain of quantification
...
\begin{isamarkuptext}%
\noindent{Frame's accessibility relation and modal operators \isa{{\isasymbox}} and \isa{{\isasymdiamond}}.}%
\end{isamarkuptext}\isamarkuptrue%
\ \ \isacommand{consts}\isamarkupfalse%
...
from intensional terms and their type is extensional (in the color example \isa{{\isasymdown}r} would be of type \isa{{\isasymlangle}{\isasymzero}{\isasymrangle}}).
...
%
\begin{isamarkuptext}%
\noindent{(\emph{a}) Predicate \isa{{\isasymphi}} takes as argument a relativized term derived from an (intensional) individual of type \isa{{\isasymup}{\isasymzero}}.}%
\end{isamarkuptext}\isamarkuptrue%
\ \ \isacommand{abbreviation}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
\noindent{\isa{{\isasymbeta}{\isasymeta}}-redex is valid for non-relativized (intensional or extensional) terms.}%
\end{isamarkuptext}\isamarkuptrue%
\ \ \isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
\noindent{\isa{{\isasymbeta}{\isasymeta}}-redex is valid for relativized terms as long as no modal operators occur.}%
\end{isamarkuptext}\isamarkuptrue%
\ \ \isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
\noindent{As said before, intensional terms are trivially rigid. The following predicate tests whether an intensional
...
%
\begin{isamarkuptext}%
\noindent{\emph{De re} is equivalent to \emph{de dicto} for non-relativized (i.e. rigid) terms.
...
\begin{isamarkuptext}%
\noindent{Instead of postulating combinations of the above  axioms we instead make use of 
