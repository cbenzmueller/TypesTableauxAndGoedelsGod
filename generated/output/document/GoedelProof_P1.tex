...
\endisadelimtheory
%
\isamarkupsection{G\"odel's Argument, Formally (Chapter 11)%
}
\isamarkuptrue%
%
\begin{isamarkuptext}%
...
\isamarkupcmt{existence predicate in the object-language%
}
\isanewline
\isanewline
...
\ simp\ %
\isamarkupcmt{safety check: correctly matches its meta-logical counterpart%
}
%
\endisatagproof
{\isafoldproof}%
...
%
\begin{isamarkuptext}%
Definitions of God (later shown to be equivalent under axiom \isa{A{\isadigit{1}}b}):%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{abbreviation}\isamarkupfalse%
...
\begin{isamarkuptext}%
Definitions needed to formalize \isa{A{\isadigit{3}}}:%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{abbreviation}\isamarkupfalse%
...
\ blast\ %
\isamarkupcmt{axioms already imply \isa{D} axiom%
}
%
\endisatagproof
{\isafoldproof}%
...
%
\begin{isamarkuptext}%
Proposition 11.14 - Both defs (\isa{God{\isacharslash}God{\isacharasterisk}}) are equivalent. For improved performance we may prefer to use one or the other:%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
Proposition 11.15 - Possibilist existence of \isa{God{\isacharasterisk}} directly implies \isa{A{\isadigit{1}}b}:%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
Proposition 11.16 - \isa{A{\isadigit{3}}} implies \isa{P{\isacharparenleft}G{\isacharparenright}} (local consequence):%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
\isa{A{\isadigit{3}}} implies \isa{P{\isacharparenleft}G{\isacharparenright}} (as global consequence):%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
