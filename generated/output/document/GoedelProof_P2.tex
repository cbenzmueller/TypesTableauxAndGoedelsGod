...
%
\begin{isamarkuptext}%
Note that the only use Gödel makes of axiom A3 is to show that being Godlike is a positive property (\isa{T{\isadigit{2}}}). 
 We follow therefore Scott's proposal and take (\isa{T{\isadigit{2}}}) directly as an axiom (\cite{fitting_book} p. 152):%
\end{isamarkuptext}\isamarkuptrue%
