...
\end{isamarkuptext}\isamarkuptrue%
%
\isamarkupsubsection{Implicit Extensionality Assumptions%
}
\isamarkuptrue%
%
\begin{isamarkuptext}%
...
%
\begin{isamarkuptext}%
\isa{T{\isadigit{1}}} (Positive properties are possibly instantiated) can be formalised in two different ways:%
\end{isamarkuptext}\isamarkuptrue%
...
%
\begin{isamarkuptext}%
\isa{T{\isadigit{3}}} (God exists possibly) can be formalised in two different ways, using a \isa{de\ re} or a \isa{de\ dicto} reading.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{theorem}\isamarkupfalse%
...
From the last two theorems, we think \isa{T{\isadigit{3}}{\isacharunderscore}deRe} should be the version originally implied in the book,
 since \isa{T{\isadigit{3}}{\isacharunderscore}deDicto} is not valid (unless \isa{T{\isadigit{1}}b} were valid but it isn't)%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
In this variant \isa{{\isasymP}} also designates rigidly.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{axiomatization}\isamarkupfalse%
\ \isakeyword{where}\isanewline
...
%
\begin{isamarkuptext}%
Compared to Goedel's argument, the following theorems can be proven in \isa{K} logic (note that S5 no longer needed):%
\end{isamarkuptext}\isamarkuptrue%
%
\begin{isamarkuptext}%
...
\endisadelimproof
%
\isamarkupsubsection{Conclusion - Necessary Existence of God%
}
\isamarkuptrue%
%
\begin{isamarkuptext}%
Version I - \isa{de\ dicto} reading:%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
\ simp\ %
\isamarkupcmt{\isa{de\ dicto} shown here explicitly%
}
%
\endisatagproof
{\isafoldproof}%
...
%
\begin{isamarkuptext}%
Modal Collapse is countersatisfiable even in \isa{S{\isadigit{5}}}. Note that countermodels with a cardinality of one 
...
\isacommand{oops}\isamarkupfalse%
\ %
\isamarkupcmt{countermodel found in \isa{K}%
}
%
\endisatagproof
{\isafoldproof}%
...
\isamarkupcmt{assume accesibility relation is an equivalence%
}
\isanewline
\ \ \ \isanewline
\isacommand{lemma}\isamarkupfalse%
...
\isacommand{oops}\isamarkupfalse%
\ %
\isamarkupcmt{countermodel found in \isa{S{\isadigit{5}}}%
}
\isanewline
%
\endisatagproof
