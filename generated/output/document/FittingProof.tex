...
\endisadelimproof
%
\isamarkupsubsection{Conclusion (\isa{De\ re} and \isa{De\ dicto})%
}
\isamarkuptrue%
%
\begin{isamarkuptext}%
Version I - Necessary Existence of God (\isa{de\ dicto} reading):%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
Version II - Necessary Existence of God (\isa{de\ re} reading)%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
\isamarkupcmt{assume \isa{S{\isadigit{5}}} logic%
}
\isanewline
\ \ \ \isanewline
\isacommand{lemma}\isamarkupfalse%
...
\isacommand{oops}\isamarkupfalse%
\ %
\isamarkupcmt{countermodel also found in \isa{S{\isadigit{5}}}%
}
\isanewline
%
\endisatagproof
