...
%
\begin{isamarkuptext}%
\isa{T{\isadigit{1}}} (Positive properties are possibly instantiated) can be formalized in two different ways:%
\end{isamarkuptext}\isamarkuptrue%
...
%
\begin{isamarkuptext}%
\isa{T{\isadigit{3}}} (God exists possibly) can be formalized in two different ways, using a \isa{de\ re} or a \isa{de\ dicto} reading.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{theorem}\isamarkupfalse%
