...
intensional counterpart (e.g. \isa{{\isasymlparr}{\isasymphi}{\isasymrparr}\ {\isasymequiv}\ {\isasymlambda}w{\isachardot}\ {\isasymphi}}). They were introduced only for type correctness.%
\end{isamarkuptext}\isamarkuptrue%
